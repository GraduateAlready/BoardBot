...
function generateRoute(model, idmap){
...
export default class Home extends Component {
  ...
  async loadModel() {
    ...
    let visualdisplay = generateRoute(model, idmap)
    console.log(isRouteValid(visualdisplay))
    while(!isRouteValid(visualdisplay)){
      visualdisplay = generateRoute(model, idmap)
      console.log("Fail reloading")
      console.log(isRouteValid(visualdisplay))
    }
